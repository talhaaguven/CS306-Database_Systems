...
while($row = mysqli_fetch_assoc($result)) { // Iterating the result
    ...
    include "music_info_table.php";
  
    $sql_statement = "SELECT * FROM creating NATURAL JOIN artist WHERE music_id ='$music_id'";
    $result = mysqli_query($db, $sql_statement);
    while($row = mysqli_fetch_assoc($result)) { // Iterating the result
        $artist=$row['a_name']; 
...
$result = mysqli_query($db, $sql_statement);
while($row = mysqli_fetch_assoc($result)) { // Iterating the result
    $sql_statement = "SELECT * FROM produces NATURAL JOIN producer WHERE music_id ='$music_id'";
    $result = mysqli_query($db, $sql_statement);
    while($row = mysqli_fetch_assoc($result)) { // Iterating the result

        $producer=$row['prdoucer_name']; 
        $producer_id= $row['producer_id']; 
        echo "  <tr><td><a href='producer_info.php?id=$producer_id'> $producer </a></td>
        <br>";
        } 
    }
?>
