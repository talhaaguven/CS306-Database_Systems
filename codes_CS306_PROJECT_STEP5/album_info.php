...
include "config.php"; 
$album_id = $_GET["id"];
$sql_statement = "SELECT * FROM album WHERE album_id ='$album_id'";
...
while($row = mysqli_fetch_assoc($result)) { // Iterating the result
    ...
    $result = mysqli_query($db, $sql_statement);
            while($row = mysqli_fetch_assoc($result)) { // Iterating the result
                ...
                include "platform_table_album.php";
                } 
...
<thead>
        <tr>
            <th scope="col"> Contained Music </th>
...
while($row = mysqli_fetch_assoc($result)) {
  ...
  $sql_statement = "SELECT * FROM contains NATURAL JOIN music WHERE album_id ='$album_id'";
  $result = mysqli_query($db, $sql_statement);
          while($row = mysqli_fetch_assoc($result)) { // Iterating the result
              $music_name=$row['music_name'];
              $music_id = $row['music_id'];
              //include "music_table_album.php";
