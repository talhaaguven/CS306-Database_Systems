...
<center>
    <h1 class="text"> Producer Info</h1>
    </h1>
    <ul>
...
while($row = mysqli_fetch_assoc($result)) { // Iterating the result
    ...
    include "producer_info_table.php";
...
<thead>
        <tr>
            <th scope="col"> Produced Music  </th>
...
while($row = mysqli_fetch_assoc($result)) { // Iterating the result
  $sql_statement = "SELECT * FROM produces NATURAL JOIN music WHERE producer_id ='$producer_id'";
